...
export interface INotifier {
     ...
     */
    Send(name: string, body?: any, type?: string): void;
}
...
export class Notifier implements INotifier {
     ...
     */
    Send(name: string, body: any = null, type: string = ""): void {
...
export class Facade implements IFacade {
    ...
    public FindProxy<T extends Proxy>(proxyConstructor: ProxyConstructor<T>): T {
        return this.retrieveProxy(proxyConstructor.name);
    }
     ...
     */
    Send(name: string, body: any = null): void {
...
export class Notification implements INotification {
     ...
     */
    constructor(name: string, body: any = null) {
        this.name = name;
        this.body = body; 
    }
